...
# Import target "Lua::lua_shared" for configuration "Release"
set_property(TARGET Lua::lua_shared APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(Lua::lua_shared PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/lua_shared.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/lua_shared.dll"
  )
...
# Import target "Lua::luac" for configuration "Release"
set_property(TARGET Lua::luac APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
